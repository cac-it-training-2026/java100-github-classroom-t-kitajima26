		...
		while (i < 3) {
			...
			if (hand == 1) {
				...
				if (alligator == 3) {
					...
					String result = (alligator == 1) ? "グーワ二" : "チョキワニ";
					System.out.println("相手は" + result + "でした。");
					System.out.println((1 + 1) + "匹目通り抜け成功！");
				}
			} else if (hand == 2) {
				System.out.println("隊長：");
				if (alligator == 1) {
					...
					String result = (alligator == 3) ? "パーワ二" : "チョキワニ";
					System.out.println("相手は" + result + "でした。");
					System.out.println((1 + 1) + "匹目通り抜け成功！");
				}
			} else if (hand == 3) {
				...
				if (alligator == 2) {
					...
					String result = (alligator == 1) ? "グーワ二" : "パーワニ";
					System.out.println("相手は" + result + "でした。");
					System.out.println((1 + 1) + "匹目通り抜け成功！");
				}

...
public class Patisserie {
	public static void main(String[] args) throws IOException {
		...
		int threePrice = (int) ((250 * (250 * citronBuyCount) / totalPrice)
				+ (280 * (280 * chocolatBuyCount) / totalPrice) + (320 * (320 * pistacheBuyCount) / totalPrice));

		System.out.println("\nが楽しめます！\n");
		System.out.println("値段は\\" + (int) (threePrice / 10) * 10 + "です。");
